...
public class YCircleImageView extends AppCompatImageView {
    ...
    public YCircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.YCircleImageView, defStyle, 0);
        // 自定义原型图片边框属性
        mBorderWidth = a.getDimensionPixelSize(R.styleable.YCircleImageView_border_width, DEFAULT_BORDER_WIDTH); // 边框大小
        mBorderColor = a.getColor(R.styleable.YCircleImageView_border_color, DEFAULT_BORDER_COLOR); // 边框颜色
        a.recycle();
        init();
    }
