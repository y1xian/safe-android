 ...
 */
public class YDrawableTextView extends AppCompatTextView {
    ...
    public YDrawableTextView(Context context) {
        this(context, null);
    }

    public YDrawableTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public YDrawableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.YDrawableTextView);
        drawables[0] = array.getDrawable(R.styleable.YDrawableTextView_leftDrawable);
        drawables[1] = array.getDrawable(R.styleable.YDrawableTextView_topDrawable);
        drawables[2] = array.getDrawable(R.styleable.YDrawableTextView_rightDrawable);
        drawables[3] = array.getDrawable(R.styleable.YDrawableTextView_bottomDrawable);

        widths[0] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_leftDrawableWidth, 0);
        widths[1] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_topDrawableWidth, 0);
        widths[2] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_rightDrawableWidth, 0);
        widths[3] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_bottomDrawableWidth, 0);

        heights[0] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_leftDrawableHeight, 0);
        heights[1] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_topDrawableHeight, 0);
        heights[2] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_rightDrawableHeight, 0);
        heights[3] = array.getDimensionPixelSize(R.styleable.YDrawableTextView_bottomDrawableHeight, 0);
