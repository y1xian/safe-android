 ...
 */
public class YStateButton extends AppCompatTextView {
    //text color
    ...
    public YStateButton(Context context) {
        this(context, null);
    }

    public YStateButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public YStateButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.YStateButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.YStateButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.YStateButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.YStateButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.YStateButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.YStateButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.YStateButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.YStateButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.YStateButton_radius, 0);
        mRound = a.getBoolean(R.styleable.YStateButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.YStateButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.YStateButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.YStateButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.YStateButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.YStateButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.YStateButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.YStateButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.YStateButton_unableStrokeColor, 0);
        setStroke();
