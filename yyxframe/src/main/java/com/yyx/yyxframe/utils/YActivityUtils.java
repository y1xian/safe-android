...
public class YActivityUtils {
    private static YActivityUtils mYActivityUtils;
    private final String TAG = "YActivityUtils.";
    private Intent mIntent;

    private YActivityUtils() {
        mIntent = new Intent();
    }
     ...
     * @return
     */
    public static YActivityUtils getActivityUtil() {
        return mYActivityUtils = null == mYActivityUtils ? new YActivityUtils() : mYActivityUtils;
    }
        ...
        if (null != activities) {
            for (int i = 0; i < activities.size(); i++) {
                ...
                if (activity != null) {
                    ...
                    YLog.e(TAG + "finishActivities()", "集合中数据为空。数据索引为：" + i);
                }
            }
        } else {
            YLog.e(TAG + "finishActivities()", "参数值传入为空");
        }
    }
    ...
    public void startActivity(Context context, Class clazz) {
        if (null != context && null != clazz) {
            ...
            YLog.e(TAG + "startActivity()", "参数值传入为空");
        }
    }
    ...
    public void startActivityClearAllInstances(Context context, Class<?> clazz) {
        if (null != context && null != clazz) {
            ...
            YLog.e(TAG + "startActivityClearAllInstances()", "参数值传入为空");
        }
    }
    ...
    public void startActivityWithIntegerData(Context context, Class clazz, Map<String, String> data) {
        if (null!=context&&null != clazz) {
            ...
            if (data != null) {
                ...
                YLog.e(TAG + "startActivityWithIntegerData()", "参数data的值传入为空");
            }
            context.startActivity(mIntent);
        }else {
            YLog.e(TAG + "startActivityWithIntegerData()", "参数值传入为空");
        }
    }
            ...
            if (data != null) {
                for (Entry<String, Object> en : data.entrySet()) {
                    ...
                    if (value instanceof Serializable) {
                        ...
                        YLog.e(TAG + "startActivityWithObjectData()", "传入的类型不符合规定");
                    }

                }
            } else {
                YLog.e(TAG + "startActivityWithObjectData()", "参数data的值传入为空");
            }
            context.startActivity(mIntent);
        } else {
            YLog.e(TAG + "startActivityWithObjectData()", "参数值传入为空");
        }
    }
            ...
            if (data != null) {
                for (Entry<String, Object> en : data.entrySet()) {
                    ...
                    if (value instanceof Serializable) {
                        ...
                        YLog.e(TAG + "startActivityWithObjectData()", "带请求标识的方法传入的类型不符合规定");
                    }
                }
            } else {
                YLog.e(TAG + "startActivityWithObjectData()", "带请求标识的方法参数data的值传入为空");
            }
            activity.startActivityForResult(mIntent, requestCode);
        } else {
            YLog.e(TAG + "startActivityWithObjectData()", "带请求标识的方法参数值传入为空");
        }
    }
            ...
            if (data != null) {
                for (Entry<String, Object> en : data.entrySet()) {
                    ...
                    if (value instanceof Serializable) {
                        ...
                        YLog.e(TAG + "startFragmentWithObjectData()", "传入的类型不符合规定");
                    }
                }
            } else {
                YLog.e(TAG + "startFragmentWithObjectData()", "参数data的值传入为空");
            }
            fragment.startActivityForResult(mIntent, requestCode);
        } else {
            YLog.e(TAG + "startFragmentWithObjectData()", "参数值传入为空");
        }
    }
    ...
    public void startActivityForBundleData(Activity activity, Class clazz, Serializable serializableObj, Map<String, Object> datas, int requestCode) {
        if (null != activity && clazz != null) {
            ...
            if (serializableObj != null) {
                ...
                YLog.e(TAG + "startActivityForBundleData()", "参数serializableObj的值传入为空");
            }
            if (datas != null) {
                for (Entry<String, Object> en : datas.entrySet()) {
                    ...
                    if (value instanceof Long) {
                        ...
                        YLog.e(TAG + "startActivityForBundleData()", "传入的类型不符合规定");
                    }
                }
            } else {
                YLog.e(TAG + "startActivityForBundleData()", "参数datas的值传入为空");
            }
            activity.startActivityForResult(mIntent, requestCode);
        } else {
            YLog.e(TAG + "startActivityForBundleData()", "参数值传入为空");
        }
    ...
    public void startActivityForData(Context context, Class clazz, Serializable serializableObj, Map<String, String> datas) {
        if (null != context && clazz != null) {
            ...
            if (serializableObj != null) {
                ...
                YLog.e(TAG + "startActivityForData()", "参数serializableObj的值传入为空");
            }
            if (datas != null) {
                ...
                YLog.e(TAG + "startActivityForData()", "参数datas的值传入为空");
            }

            context.startActivity(mIntent);
        } else {
            YLog.e(TAG + "startActivityForData()", "参数值传入为空");
        }
    ...
    public void startActivityForBundleListObj(Context context, Class clazz, List<Serializable> serializableList) {
        if (null != context && clazz != null) {
            ...
            if (serializableList != null) {
                ...
                YLog.e(TAG + "startActivityForBundleListObj()", "参数list的值传入为空");
            }
            context.startActivity(mIntent);
        } else {
            YLog.e(TAG + "startActivityForBundleListObj()", "参数值传入为空");
        }
    ...
    public void startActivityForObj(Context context, Class clazz, Serializable serializableObj) {
        if (null != context && clazz != null) {
            ...
            if (serializableObj != null) {
                ...
                YLog.e(TAG + "startActivityForObj()", "参数serializableObj的值传入为空");
            }
            context.startActivity(mIntent);
        } else {
            YLog.e(TAG + "startActivityForObj()", "参数值传入为空");
        }
    ...
    public void startActivityForObjWhy(Activity activity, Class clazz, Serializable serializableObj, int why) {
        if (null != activity && clazz != null) {
            ...
            if (serializableObj != null) {
                ...
                YLog.e(TAG + "startActivityForObjWhy()", "参数serializableObj的值传入为空");
            }
            activity.startActivityForResult(mIntent, why);
        } else {
            YLog.e(TAG + "startActivityForObjWhy()", "参数值传入为空");
        }
