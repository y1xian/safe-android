package com.yyx.yyxframe.utils.statusbar;
 ...
 * 状态栏
 */
public class YStatusBarUtils {

    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.yyx_statusbar_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.yyx_statusbar_translucent_view;
