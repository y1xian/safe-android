package com.yyx.yyxframe.utils.anim;
 ...
 * 视图动画工具类
 */
public class YViewAnimationUtils {

    private YViewAnimationUtils() {
    ...
    public static void invisibleViewByAlpha(final View view, long durationMillis, final boolean isBanClick,
        ...
        if (view.getVisibility() != View.INVISIBLE) {
            ...
            AlphaAnimation hiddenAlphaAnimation = YAnimationUtils.getHiddenAlphaAnimation(durationMillis);
    ...
    public static void invisibleViewByAlpha(final View view, boolean isBanClick, final AnimationListener animationListener) {
        invisibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, isBanClick, animationListener);
    }
    ...
    public static void invisibleViewByAlpha(final View view, final AnimationListener animationListener) {
        invisibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, false, animationListener);
    }
    ...
    public static void invisibleViewByAlpha(final View view, boolean isBanClick) {
        invisibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, isBanClick, null);
    }
    ...
    public static void invisibleViewByAlpha(final View view) {
        invisibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, false, null);
    }
    ...
    public static void goneViewByAlpha(final View view, final boolean isBanClick, final AnimationListener animationListener) {
        goneViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, isBanClick, animationListener);
    }
    ...
    public static void goneViewByAlpha(final View view, final AnimationListener animationListener) {
        goneViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, false, animationListener);
    }
    ...
    public static void goneViewByAlpha(final View view, final boolean isBanClick) {
        goneViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, isBanClick, null);
    }
    ...
    public static void goneViewByAlpha(final View view) {
        goneViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, false, null);
    }
    ...
    public static void visibleViewByAlpha(final View view, long durationMillis,
        ...
        if (view.getVisibility() != View.VISIBLE) {
            ...
            AlphaAnimation showAlphaAnimation = YAnimationUtils.getShowAlphaAnimation(durationMillis);
    ...
    public static void visibleViewByAlpha(final View view, final boolean isBanClick, final AnimationListener animationListener) {
        visibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, isBanClick, animationListener);
    }
    ...
    public static void visibleViewByAlpha(final View view, final AnimationListener animationListener) {
        visibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, false, animationListener);
    }
    ...
    public static void visibleViewByAlpha(final View view, final boolean isBanClick) {
        visibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION,
                isBanClick, null);
    }
    ...
    public static void visibleViewByAlpha(final View view) {
        visibleViewByAlpha(view, YAnimationUtils.DEFAULT_ANIMATION_DURATION, false, null);
    }
