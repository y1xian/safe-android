...
public class YRandomUtils {
     ...
     * @param length
     * @return
     * @see YRandomUtils#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link YRandomUtils#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
