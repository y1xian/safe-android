 ...
 * 屏幕、尺寸、View相关工具类
 */
public class YDensityUtils {

    private YDensityUtils() {
    ...
    public static int dp2px(float dpValue) {
        final float scale = YFrame.getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = YFrame.getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidth() {
        return YFrame.getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return YFrame.getDisplayMetrics().heightPixels;
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) YFrame.getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = YFrame.getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = YFrame.getResources();
