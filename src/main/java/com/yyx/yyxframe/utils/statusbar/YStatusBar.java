 ...
 * 设置状态栏沉浸式或者状态栏颜色
 */
public class YStatusBar {
    public static final int DEFAULT_STATUS_BAR_ALPHA = 112;
    public static final int FAKE_STATUS_BAR_VIEW_ID = R.id.yyx_statusbar_fake_status_bar_view;
    public static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.yyx_statusbar_translucent_view;
