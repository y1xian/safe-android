 ...
 */
public final class YSDCardUtils {

    private YSDCardUtils() {
    ...
    public static List<String> getSDCardPaths(final boolean removable) {
        ...
        StorageManager sm =
                (StorageManager) YFrame.getContext().getSystemService(Context.STORAGE_SERVICE);
        try {
    ...
    public static List<String> getSDCardPaths() {
        StorageManager storageManager = (StorageManager) YFrame.getContext()
