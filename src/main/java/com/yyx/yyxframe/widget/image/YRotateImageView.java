 ...
 */
public class YRotateImageView extends AppCompatImageView {

    private RotateAnimation mAnimation;
    private boolean mIsHasAnimation;

    public YRotateImageView(Context context) {
        super(context);
    }

    public YRotateImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public YRotateImageView(Context context, AttributeSet attrs, int defStyle) {
